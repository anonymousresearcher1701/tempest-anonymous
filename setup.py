...
setup(
    name="tempest_anonymous",
    version=read_version_number(),
    author="Anonymous Researcher1701",
    author_email="anonymous.researcher1701@gmail.com",
    ...
    url="https://github.com/anonymousresearcher1701/tempest-anonymous",
