...
int main(const int argc, char* argv[]) {
    ...
    const Tempest tempest(true, use_gpu);
    ...
    const auto walks_forward = tempest.get_random_walks_and_times_for_all_nodes(
        20,
        &linear_picker_type,
        10,
    ...
    const auto walks_backward = tempest.get_random_walks_and_times_for_all_nodes(
        20,
        &linear_picker_type,
        10,
