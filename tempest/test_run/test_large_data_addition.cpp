...
int main(const int argc, char* argv[]) {
    ...
    const Tempest tempest(true, use_gpu, sliding_window_duration, true);
    ...
    for (size_t i = 0; i < file_paths.size(); ++i) {
        ...
        std::cout << "Adding " << current_sources.size() << " edges to tempest..." << std::endl;
        ...
        const auto active_edge_count = tempest.get_edge_count();
        ...
        auto walks = tempest.get_random_walks_and_times(
