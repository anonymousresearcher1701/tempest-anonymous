...
int main(int argc, char* argv[]) {
    ...
    Tempest tempest(false, use_gpu, -1, true, 34);
    ...
    const auto walks_backward_for_all_nodes_1 = tempest.get_random_walks_and_times(
        80,
    ...
    const auto walks_forward_for_all_nodes_1 = tempest.get_random_walks_and_times(
        80,
        &exponential_picker_type,
        NUM_WALKS_TOTAL,
        &uniform_picker_type,
    ...
    const auto walks_backward_for_all_nodes_2 = tempest.get_random_walks_and_times(
        80,
        &exponential_picker_type,
        NUM_WALKS_TOTAL,
        &uniform_picker_type,
